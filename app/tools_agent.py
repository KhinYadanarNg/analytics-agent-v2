...
def get_success_rate_by_file_name_tool(
    ...
    """Calculate success/failure percentage for a file, optionally filtered by org and date range.
    ...
    def run_async_db_call():
        ...
        try:
            # FIX: Changed from get_success_rate_by_file_id to get_success_rate_by_file_name
