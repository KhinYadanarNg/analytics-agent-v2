...
- Handle relative dates like "today", "yesterday", "this week", "last month" by converting to actual dates
- Examples:
  ...
  * "from today" → start_date="2025-09-12" (current date)
  * "yesterday" → start_date="2025-09-11", end_date="2025-09-11"
